...
<body>
					...
					<div class="mgt-tool-bar" style="margin-bottom: 0;">
						<div class="mgt-tool-bar" style="overflow:visible;">
							<div class="search-bar">
								...
								<label class="pull-left" id="handlerLabel">管理用户</label>
								<select class="pull-left" id="handler" name="handler">
									<option value="">请选择...</option>
								</select>
								<div style="width: 100%;height: 30px;clear: both;"></div>
								<label class="pull-left">需求类别</label>
								<select class="pull-left" id="requireType" name="requireType">
									<option value="">请选择...</option>
									<option value="技术需求">技术需求</option>
									<option value="产品需求">产品需求</option>
									<option value="融资需求">融资需求</option>
								</select>
								<label class="pull-left">需求名称</label>
								<input type="text" class="pull-left" id="requireName"/>
								<!--<label class="pull-left">设备设施类别</label>
								 <select class="pull-left" id="equipType">
								...
								<div style="width: 100%;height: 30px;clear: both;"></div>
								<label class="pull-left">需求有效时间</label>
								<input type="text" class="pull-left" id="validStartDate" placeholder="请输入开始时间" />
								<label class="hidden"></label>
								<label class="pull-left" style="margin-left: 0;">&nbsp;&nbsp;--&nbsp;&nbsp;</label>
								<input type="text" class="pull-left" id="validEndDate" placeholder="请输入结束时间"/>
								<label class="hidden"></label>
						...
						<table class="table list-box" id="goods_table">
							<thead>
								<tr>
									...
									<td class="tdw100">需求名称</td>
									<td class="tdw70">需求类别</td>
									<td class="tdw70">所属部门</td> 
									<td class="tdw70">管理用户</td>
									<td class="tdw100">审核时间</td>
									<td class="tdw100">审核状态</td>
	...
	<script src="${contextPath}/trm_modules/demand/ucenter/srchlist.js"></script>
</body>
</html>
