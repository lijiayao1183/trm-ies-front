...
<body>
	...
	<div class="full-container content" style="margin:0;">
		<div class="container filter-box">
			<div class="row" style="line-height:38px;">
				...
				<ul class="breadcrumb">
					<li><a href="/">首页</a></li>
					<li class="active">军民融合需求列表</li>
				</ul>
			</div>
			<div class="pull-left news-nav">
				<ul>
					<li class="active">全部需求</li>
					 <li flagCode="技术需求">技术需求</li>
					<li flagCode="产品需求">产品需求</li>
					<li flagCode="融资需求">融资需求</li>
	...
	<script src="${contextPath}/trm_modules/demand/front/srchlist.js"></script>
</body>
</html>