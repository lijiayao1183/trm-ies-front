...
<body>
				...
				<div class="row content-box">
					<div class="mgt-tool-bar">
						<div class="search-bar">
							...
							<label class="pull-left">服务领域类别</label>
							<select class="pull-left" id="serviceRange">
								<option selected>请选择...</option>
							</select>
							<label class="pull-left">设备设施名称</label>
							<input type="text" class="pull-left" id="equipName"/>
							<div style="width: 100%;height: 30px;clear: both;"></div>
							<label class="pull-left">设备实施名称</label>
							<input type="text" class="pull-left" id="equipName" name="equipName" />
							<label class="pull-left">持有单位</label>
							<input type="text" class="pull-left" id="orgName" name="orgName" />
	...
	<script src="${contextPath}/trm_modules/follow/ucenter/srchlist.js"></script>
</body>
</html>