...
<div class="full-container headerbg">
	<div class="container header">
		...
		<div class="header-nav" style="display:inline-block;margin-top:6px;">
			<ul class="navbar-nav">
		...
		<div class="navbar-right">
			 <c:choose>
			    ...
			    <div class="btn-bar btn-bar-div" id="login_part" style="margin-top: 10px;">
					...
					<div class="personal-center" id="personal_center">
						...
						<div class="pc-content">
							...
							<a href="${contextPath}/logout.action" class="exit" id="exit1">退出</a>
						</div>
					</div>
				</div>
				<script>
				...
				(function () {
					var oA = document.getElementById("exit1");
					oA.onclick = function(){
