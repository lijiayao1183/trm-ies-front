 ...
 * 
 * 全文检索
 * @author zhaosimiao 2017-12-1 13:33:36
 *
 */
@Component
public class JestService {
    ...
    public JestClient getJestClient() {
        ...
        factory.setHttpClientConfig(new HttpClientConfig
                .Builder(jestUrl+":"+jestProt)
                .gson(new GsonBuilder().setDateFormat(dateFormat).create())
                .connTimeout(Integer.valueOf(connTimeout))
    ...
    public void setJestUrl(String jestUrl) {
        this.jestUrl = jestUrl;
    }

    public String getJestProt() {
        return jestProt;
    }

    public void setJestProt(String jestProt) {
        this.jestProt = jestProt;
    }
