...
public class SessionBean implements Serializable {
	...
	public String toString() {
		return "SessionBean [id=" + id + ", username=" + username
				+ ", password=" + password + ", nickName=" + nickName
				+ ", phone=" + phone + ", email=" + email + ", qq=" + qq
				+ ", weChat=" + weChat + ", problem=" + problem + ", answer="
				+ answer + ", userType=" + userType + ", orgName=" + orgName
				...
				+ ", city=" + city + ", area=" + area + ", audStatus="
				+ audStatus + ", audDate=" + audDate + ", audOpinion="
				+ audOpinion + ", audPerson=" + audPerson + ", remark="
				+ remark + ", headPortrait=" + headPortrait + ", isNtblisted="
				+ isNtblisted + ", isWepermited=" + isWepermited
				+ ", isWeqkept=" + isWeqkept + ", address=" + address + "]";
	}
}
