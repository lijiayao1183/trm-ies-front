...
//    private String password;
	...
	public String toString() {
		return "MemberDetail [id=" + id + ", username=" + username + ", nickName=" + nickName + ", phone=" + phone
				+ ", email=" + email + ", qq=" + qq + ", weChat=" + weChat + ", problem=" + problem + ", answer="
				+ answer + ", userType=" + userType + ", orgName=" + orgName + ", orgProperty=" + orgProperty
				+ ", isListed=" + isListed + ", isHighNew=" + isHighNew + ", masterType=" + masterType + ", master="
				+ master + ", orgBrief=" + orgBrief + ", licensePdf=" + licensePdf + ", promisePdf=" + promisePdf
				+ ", linkPerson=" + linkPerson + ", department=" + department + ", numberId=" + numberId + ", province="
				+ province + ", city=" + city + ", area=" + area + ", audStatus=" + audStatus + ", audDate=" + audDate
				+ ", audOpinion=" + audOpinion + ", audPerson=" + audPerson + ", remark=" + remark + ", headPortrait="
				+ headPortrait + ", isNtblisted=" + isNtblisted + ", isWepermited=" + isWepermited + ", isWeqkept="
				+ isWeqkept + ", address=" + address + ", creditId=" + creditId + "]";
	}
