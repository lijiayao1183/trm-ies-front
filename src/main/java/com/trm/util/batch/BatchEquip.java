...
public class BatchEquip {
	...
	public BatchEquip(Integer id, String equipName, String equipType, String serviceRange, String equipVerCode,
			String proCountry, String createFirm, String serviceMode, String equipValue, String purchaseDate,
			String linkPerson, String email, String linkPhone, String useField, String qualification, String tecFeature,
			String linkUnit, String linkAddress) {
		super();
		this.id = id;
	...
	public String toString() {
		return "BatchEquip [id=" + id + ", equipName=" + equipName + ", equipType=" + equipType + ", serviceRange="
				+ serviceRange + ", equipVerCode=" + equipVerCode + ", proCountry=" + proCountry + ", createFirm="
				+ createFirm + ", serviceMode=" + serviceMode + ", equipValue=" + equipValue + ", purchaseDate="
				+ purchaseDate + ", linkPerson=" + linkPerson + ", email=" + email + ", linkPhone=" + linkPhone
				+ ", useField=" + useField + ", qualification=" + qualification + ", tecFeature=" + tecFeature
				+ ", linkUnit=" + linkUnit + ", linkAddress=" + linkAddress + "]";
	}
