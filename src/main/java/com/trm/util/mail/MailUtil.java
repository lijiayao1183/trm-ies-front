...
public class MailUtil {
	 ...
	 * 邮件主题
	 */
	private static final String subject = "密码重设-陕西军民融合科技创新资源开放共享管理服务平台";
	
	/**
	 * 邮件内容
	 */
	private String content = "<p>亲爱的yhm：</p>"
						+ "<p style='text-align: justify; text-indent: 2em;'>您好，接收到这封邮件是因为您希望通过邮箱验证方式找回登录密码。</p>"
						+ "<p style='text-align: justify; text-indent: 2em;'>如果重设密码，请点击链接</p>"
						+ "<p style='text-align: justify; text-indent: 2em;'>"
						+ "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style='color: rgb(192, 0, 0); font-size: 20px;'>http://113.201.62.250:18080/views/content/login/front/changepassword.jsp?username=yhm&code=uuid</span>"
						+ "</p>"
	...
	public void send(String username, String uuid, String to) {
		...
		try {
			...
			// 内容为HTML
			String userContent = content.replaceAll("yhm", username).replaceAll("uuid", uuid);
	...
	public static void main(String[] args) {
		new MailUtil().send("threewater603", "UUid", "zhaosimiao@trm-cloud.com");
	}
}